let networkStatus = null; // 'offline' | 'slow' | null

function renderNetworkNotification() {
  let el = document.getElementById('network-notification');

  if (!el) {
    el = document.createElement('div');
    el.id = 'network-notification';
